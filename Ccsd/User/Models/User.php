...

{
    ...
    /**
     *
     * @var Longueur du répertoire où sont stockés les images des comptes
     *      utilisateur
     */
     ...
     * @return boolean
     */
    static function hasPhoto($uid = null)
    {
    ...
    {
        return Ccsd_File::slicedPathFromString($this->getUid(), CCSD_USER_PHOTO_PATH . '/', self::CCSD_USER_PHOTO_PATH_LENGHT, 2, '0');
    }
